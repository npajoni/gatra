"""
Django settings for gatra project.
...
INSTALLED_APPS = [
    ...
    'gatra_thirdparty.apps.GatraThirdpartyConfig',
]
...
WSGI_APPLICATION = 'gatra.wsgi.application'

CORS_URLS_REGEX = r'^/play/$'
